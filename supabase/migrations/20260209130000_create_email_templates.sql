-- ============================================
-- EMAIL TEMPLATES SYSTEM (SEM SMTP/EDGE FUNCTIONS)
-- Sistema de templates de email configuráveis via CMS
-- ============================================
...
CREATE TABLE email_templates (
  ...
  UNIQUE(type, is_active) WHERE is_active = true
);

-- Tabela de log de emails (para registro futuro, se necessário)
...
-- Email Templates (admins e editors podem visualizar, apenas admins podem editar)
...
-- Email Logs (somente leitura para admins/editors)
...
<head>
  ...
  <style>
    ...
    .button { display: inline-block; padding: 12px 30px; background-color: #8BC34A; color: white; text-decoration: none; border-radius: 5px; margin: 20px 0; }
...
<body>
  <div class="container">
    <div class="header">
      <h1>Cooprosoja</h1>
      <p>Cooperativa de Produtores de Soja</p>
    </div>
    <div class="content">
      <h2>Olá, {{nome}}!</h2>
      <p>Recebemos sua solicitação para se tornar um cooperado da <strong>Cooprosoja</strong>.</p>
      ...
      <p>Nossa equipe analisará sua solicitação e entrará em contato em breve para dar continuidade ao processo de associação.</p>

      <p class="highlight">O que acontece agora?</p>
      <ol>
        <li>Análise dos dados enviados</li>
        <li>Verificação de requisitos</li>
        <li>Contato da nossa equipe em até 48 horas úteis</li>
      </ol>

      <p>Se você tiver alguma dúvida, não hesite em entrar em contato conosco.</p>
    </div>
    <div class="footer">
      <p><strong>Cooprosoja</strong></p>
      <p>Telefone: {{telefone_cooprosoja}} | E-mail: {{email_cooprosoja}}</p>
      <p>&copy; 2024 Cooprosoja - Todos os direitos reservados</p>
    </div>
  </div>
</body>
</html>',
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>Uma nova pessoa demonstrou interesse em se tornar cooperado</p>
    </div>
    <div class="content">
      ...
      <ol>
        ...
        <li>Revisar os dados do candidato</li>
        <li>Entrar em contato para prosseguir com o processo</li>
      </ol>

      <a href="{{admin_url}}" class="button">Acessar Painel Admin</a>
    </div>
  </div>
</body>
</html>',
